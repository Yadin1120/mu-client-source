...
// Draws one line of text into the font DC using the writing direction the line needs: a line which
// starts in Hebrew is laid out right-to-left, so English words, item names, numbers and player
// names inside it land where a Hebrew reader expects them. See UIControls.cpp for the details.
