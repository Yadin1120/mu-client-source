...
protected:
    ...
    // 128 to match the shop.ini Host buffer: the original 20 chars only fit an IPv4 literal,
    // and copying a real hostname/domain into it overflowed the field and corrupted the object.
    wchar_t					m_szScriptIPAddress[128];
    wchar_t					m_szBannerIPAddress[128];
