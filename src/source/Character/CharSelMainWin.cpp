...
namespace
{
    // Derived, never a literal: this drives HasEmptyCharacterSlot(), which is what
    // enables the Create button. When it drifted below MAX_CHARACTERS_PER_ACCOUNT the
    // server accepted more characters but the button stayed greyed out (03/08/2026).
    constexpr int kCharacterSlotCount = MAX_CHARACTERS_PER_ACCOUNT;
