...
// Shows the red protocol-value overlay on the shop buy/storage dialogs
// (ItemCode/PackageSeq/PriceSeq/CashType), without enabling the unrelated
// FOR_WORK internals. Re-enable (uncomment) only when debugging the shop protocol.
//#define XSHOP_DEBUG_OVERLAY
