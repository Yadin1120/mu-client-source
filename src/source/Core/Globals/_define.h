...
// Keep in sync with the server's MaximumCharactersPerAccount and with
// g_CharacterSlotPositions in WSclient.cpp (one standing spot per slot).
#define MAX_CHARACTERS_PER_ACCOUNT 7
