...
enum
{
    ...
    // MU Pass season 1 - cosmetic Knight Blade variants. Same geometry as
    // Sword21.bmd, only the texture folder and the glow colour differ.
    MODEL_MUPASS_ROYAL = MODEL_SWORD + 36,
    MODEL_MUPASS_FROST = MODEL_SWORD + 37,
    MODEL_MUPASS_VOID = MODEL_SWORD + 38,
